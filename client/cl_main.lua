...
CreateThread(function() 
	for k, v in pairs(Config.Locations["police"]) do
        ...
        options = {
            {
                type = "client",
                event = "ns-frontdesk:client:OpenFrontDesk",
                icon = "fas fa-desktop",
                label = "Front Desk",
            },
        },
...
RegisterNetEvent('ns-frontdesk:client:OpenFrontDesk',function()
    if IsValidJob() then
    local FrontDeskMenu = {
        {
        ...
        },
        {
            ...
            params = {
                event = 'ns-frontdesk:client:ToggleDuty'
            }
        },  
        {
            ...
            params = {
                event = 'ns-frontdesk:client:OpenAssistanceMenu'
            }
        },
        {
            header = 'Exit Menu',
    ...
    local FrontDeskMenu = {
        ...
        },
        {
            ...
            disabled = true,
            params = {
                event = 'ns-frontdesk:client:OpenDutyMenu'
            }
        },  
        {
            header = 'Assistance Menu',
...
RegisterNetEvent('ns-frontdesk:client:ToggleDuty',function()
    TriggerServerEvent('QBCore:ToggleDuty')
end)


RegisterNetEvent('ns-frontdesk:client:OpenAssistanceMenu',function()
    local AssistanceMenu = {
        ...
        },
        {
            ...
            icon = 'fas fa-hand',
            params = {
                event = 'ns-frontdesk:client:RequestAssistance',
                args = 'assistance',
            }
        },  
        {
...
RegisterNetEvent('ns-frontdesk:client:RequestAssistance',function(type)
